...
HD_PWD='C:/Users/wuyesai/Desktop/buji/buji.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log bujin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bujin.tcl -notrace
