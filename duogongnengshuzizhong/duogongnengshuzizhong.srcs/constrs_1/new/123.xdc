...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { timemode }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { Adj_Min }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { Adj_Hour }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]

# LEDs

set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { beep}]; #IO_L24P_T3_RS1_15 Sch=led[1]
#7 segment display
